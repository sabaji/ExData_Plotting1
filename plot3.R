...
## generates 3 line sub plots of Energy Sub Metring vs DateTime for 2 days 2007/02/01 and 2007/02/02.
...
## 4. Generate 3 line sub plots of Energy Sub Metring vs DateTime and output it as png
...
legend('topright',legend=c('Sub_metering_1','Sub_metering_3','Sub_metering_3'),col=c('black','red','blue'), lwd = 1)
dev.off()
